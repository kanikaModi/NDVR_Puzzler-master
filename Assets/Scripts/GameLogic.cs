...
public class GameLogic : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //winGame.GetComponent<GvrAudioSource>().Play();
    }
    ...
    public void playerSelection(GameObject sphere)
    {
        ...
        { //If the player hasn't won yet
            ...
            //sphere.GetComponent<MeshRenderer>().material = defaultMaterial;
        }
    }
    ...
    { //Begin the puzzle sequence
        ...
        restartUI1.SetActive(false);
        eventSystem.SetActive(false);
        iTween.MoveTo(player1, playPoint.transform.position, 5f);
        //startPoint.GetComponent<GvrAudioSource>().enabled = false;
        //startPoint.GetComponent<GvrAudioSource>().Play();
    ...
    { //Invoked repeating.
        ...
        //for (int ii=0; ii < puzzleSpheres.Length; ii++)
        //{
        //    puzzleSpheres[puzzleOrder[ii]].GetComponent<MeshRenderer>().material = defaultMaterial;
        //}
    ...
    { //Do this when the player gets it wrong
        ...
        failGame.GetComponent<GvrAudioSource>().Play();
        failGame.GetComponent<GvrAudioSource>().Play();
        failGame.GetComponent<GvrAudioSource>().Play();
        currentSolveIndex = 0;
